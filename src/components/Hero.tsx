      ...
      <section className="relative min-h-screen flex items-center overflow-hidden bg-background">
        ...
        <div className="section-container relative z-10 pt-20 pb-16">
          <div className="max-w-2xl mx-auto text-center">
            ...
            {/* Headline */}
            <h1
              className="font-display text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6 animate-fade-in text-primary-foreground text-center"
              style={{
                animationDelay: "0.1s",
              }}
            >
            ...
            {/* Subheadline */}
            <p
              className="text-lg md:text-xl mb-10 max-w-lg mx-auto animate-fade-in text-primary-foreground/80"
              style={{
                animationDelay: "0.2s",
              }}
            >
          ...
          <div
            className="flex items-center justify-center mt-6 animate-fade-in w-full"
            style={{
